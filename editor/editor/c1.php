...
<html>
    ...
    <link href="https://fonts.googleapis.com/css?family=Dosis" rel="stylesheet">
      ...
      <?php } ?>
            ...
            <div id="first">
                <iframe height="600px" width="100%" src="https://repl.it/repls/TrivialNutritiousTrust?lite=true" scrolling="no" frameborder="no" allowtransparency="true" allowfullscreen="true" sandbox="allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-modals"></iframe>        </body>
