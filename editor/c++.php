...
<html>
    <head><title>C++ Editor</title><link rel="icon" href="/images/learn1.png"></head>
        <body>
            <nav>
      ...
      <?php } ?>
            ...
            <div id="first">
                <iframe height="600px" width="100%" src="https://repl.it/repls/PaltryQuarterlyGenres?lite=true" scrolling="no" frameborder="no" allowtransparency="true" allowfullscreen="true" sandbox="allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-modals"></iframe>        </body>
